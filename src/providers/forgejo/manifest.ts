...
type ForgejoOptions = z.infer<typeof forgejoOptionsSchema>;

export const forgejoManifest = defineProviderManifest({
  id: 'forgejo',
  displayName: 'Forgejo',
  optionsSchema: forgejoOptionsSchema,
  createAdapter: () =>
